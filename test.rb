...
curl -X POST -H "Content-Type: application/json" -d '{"timestamp":"now","description":"testing this bug","user":{"name":"Redmine Admin","id":"admin","email":"admin@example.net"},"duration":3.0,"project":{"name":"other project","id":"other project"},"activity_type":"task"}' http://localhost:3000/api/login